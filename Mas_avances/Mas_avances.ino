...
extern uint8_t FoxParadoEscenario1[];
...
void loop() {
  ...
  if ((control1.ataque1 == LOW || control2.ataque1 == LOW) && reinicio == 1) {
    ...
    for (int z = 0; z < 8; z++) {
      delay(5);
      LCD_SpriteSD(100, 68, 40, 40, "LISTA.txt", 8, z, 0, 0);
      //  LCD_SpriteSD(46, 68, 102, 102, "LISTAG.txt", 8, z, 0, 0);
    }

    LCD_SpriteSD(100, 68, 40, 40, "LISTA.txt", 8, elec1 - 1, 0, 0);
    ...
    for (int z = 0; z < 8; z++) {
      delay(5);
      LCD_SpriteSD(175, 68, 40, 40, "LISTA.txt", 8, z, 0, 0);
      // LCD_SpriteSD(46, 68, 102, 102, "LISTAG.txt", 8, z, 0, 0);
    }
    LCD_SpriteSD(175, 68, 40, 40, "LISTA.txt", 8, elec1 - 1, 0, 0);
    //  LCD_Sprite(46, 68, 102, 102, PersonajeGrande, 8, 0, 0, 0);

    delay(500);

    LCD_FondoSD("ESC1.txt");
    LCD_SpriteSD(50, 180, 40, 40, "LISTA.txt", 8, elec1 - 1, 0, 0);
    LCD_SpriteSD(195, 180, 40, 40, "LISTA.txt", 8, elec2 - 1, 0, 0);
    ...
    while (reinicio != 1) {
      ...
      switch (elec1) {
        ...
        case 2: //*********************************Donkey********************************************
          ...
          else if (control1.horizontal <= 1000 && x <= 247) {
            if (x < 247) {
              x += 2;
              int anim = (x / 11) % 8;
      ...
      switch (elec2) {
        case 1: //********LINK**************
          //Para el primer jugador, el de la izquierda
          if (control2.horizontal <= 1000 && x != y - 25) {
          ...
          //Cuando el primer jugador quiere saltar
            ...
            for (int y1 = 0; y1 < 50; y1++) {
              ...
              int anim = (y1 / 11) % 8;
              salto++;
              LCD_SpriteSD(x, 77 - salto, 31, 74, "LINKS.txt", 3, anim, 0, 0);
            ...
            for (int y1 = 0; y1 < 32; y1++) {
              ...
              LCD_SpriteSD(x, alturafinal + salto, 31, 74, "LINKS.txt" , 3, anim, 0, 0);
          ...
          //Cuando esta parado el primer jugador
            ...
            if (ladojugador == 1) {
              int anim = (x / 11) % 8;
              LCD_SpriteSD(x, 120, 22, 48, "LINKP.txt", 2, 0, 1, 0);
              //   LCD_Sprite(x, 103, 22, 48, LinkParado, 2, 0, 1, 0);
              //  LCD_Sprite(x, 103, 44, 44, FoxParadoEscenario1, 1, 0, 1, 0);
              ...
              //LCD_Sprite(x, 103, 44, 44, FoxParadoEscenario1, 1, 0, 0, 0);
